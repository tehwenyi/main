...
all the keywords are displayed in the expense list panel. Furthermore, it also searches for words similar to the user's
input, considering that the user might have made a typing error, by applying the concept of Levenshtein distance fixed by a
upper bound.
...
Figure: FindCommand UML Sequence Diagram +
...
This part shows current implementation of the report feature. It also shows which classes or components are used in the report feature.
...
This part shows design considerations of the report feature. Multiply design considerations are showed. The pros and cons of each of the
alternative choice lists below.
...
an auto-complete feature is a nightmare for the user. The users not only need to type all the existing commands correctly but
...
Given below is an activity diagram of how the link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`autocomplete`]
feature works: +

image::AutocompleteActivityDiagram.png[width="800"]
Figure: Autocomplete activity Diagram +

This feature first requires users to enter a few letters on the link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`commandBox`]
of ePiggy, and then press *Tab* key on the keyboard to automatically complete the command.
...
[NOTE]
The auto-complete feature compares the last part of sub string from user input to the prefix of command in the checklist. It is non-case sensitive.

Example: user types " `hello add` " to the commandBox, the sub string is "add". "add" is used to compare with commands in the checklist such as "setBudget",
...
The commandBox will show " `hello addExpense n/ $/ t/ d/` " or " `hello addAllowance n/ $/ d/` ".

==== Current Implementation

This part shows current implementation of the auto-complete feature. It also shows which classes or components are used in the autocomplete feature.

The code of the auto-complete function is in link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`CommandBox`] class.
...
2. link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`findString()`] takes in the arguments and returns an array of matched commands. +
3. link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`findString()`] forms a new string using user input.
...
This part shows design considerations of the auto-complete feature. Multiply design considerations are showed. The pros and cons of each of the
alternative choice lists below.
