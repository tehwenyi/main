...
This part shows current implementation of the autocomplete feature. It also shows which classes or components are used in the autocomplete feature.

The code of the autocomplete function is in link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`CommandBox`] class.
...
This part shows design considerations of the autocomplete feature. Multiply design considerations are showed. The pros and cons of each of the
alternative choice lists below.
