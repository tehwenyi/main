...
Given below is a class diagram of how the link:https://github.com/CS2103-AY1819S2-W17-4/main/blob/master/src/main/java/seedu/address/ui/CommandBox.java[`autocomplete`]
feature works: +

image::AutocompleteActivityDiagram.png[width="600"]
Figure: Autocomplete class Diagram +
...
[NOTE]
The autocomplete feature compares the last part of sub string from user input to the prefix of command in the checklist.
