...
2. User enters search command with specific parameters.
...
2. User enters sort command with specific parameters.
...
2. User enters delete command with index of the expense record.
