...
* *Edit* : `editExpense INDEX [n/EXPENSE_NAME] [$/COST] [c/CATEGORY] [d/DATE] [t/TAG]…` +
e.g. `ee 1 n/pen $1 c/supplies`

* *Delete Expense* : `de INDEX` +
e.g. `de 3`

* *View Savings* : `viewSavings`

* *Find* : `findExpense -[n/t/d/$] [NAME/TAG/DATE RANGE/AMOUNT RANGE]` +
e.g.`fe n/MCDONALDS $/8.50:12`

* *Sort* : `sortExpense -[n/d/$]` +
e.g.`se -n`
