...
* `addAllowance n/From Mum $/20` +
This command adds a new allowance of $20 tagged as 'From Mum'.
...
*A*: You can install ePiggy in the other computer and overwrite the empty data file it creates with the file that
contains the data of your previous ePiggy folder.
