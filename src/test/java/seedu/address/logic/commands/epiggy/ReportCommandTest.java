...
public class ReportCommandTest {
    ...
    public void execute_viewSuccessful_savingsLessThanGoal() throws Exception {
        ...
        ReportCommandTest.ModelStubWithGoalAndSavingsAndExpense modelStub =
                new ReportCommandTest
                        .ModelStubWithGoalAndSavingsAndExpense(validGoal, validSavings, validExpense);
        CommandResult commandResult = null;
        try {
            commandResult = new ReportCommand().execute(modelStub, commandHistory);
        } catch (Exception e) {
            throw e;
        }
        finally {
            assertEquals(ReportCommand.MESSAGE_SUCCESS, commandResult.getFeedbackToUser());
        }
    ...
    private class ModelStubWithGoalAndSavingsAndExpense extends ReportCommandTest.ModelStub {
        ...
        final SimpleObjectProperty<Expense> expense = new SimpleObjectProperty<>();

        ModelStubWithGoalAndSavingsAndExpense(Goal goal, Savings savings, Expense expense) {
            requireNonNull(goal);
        ...
        public SimpleObjectProperty<Expense> getExpense() {
            return this.expense;
        }
    }
}
