...
public class TypicalExpenses {
    ...
    public static final Expense DUMPLING_SOUP = new ExpensesBuilder().withName("Dumpling Soup")
            .withCost("5.00")
            .withDate(CommandTestUtil.VALID_DATE_2019)
            .withTags(CommandTestUtil.VALID_TAG_FOOD, "lunch").build();
    ...
    public static final Expense MOVIE_AVENGERS = new ExpensesBuilder().withName("Avengers : Endgame movie")
            .withDate("04/26/2019")
            .withCost("8.50")
            .withTags("movie", "entertainment", CommandTestUtil.VALID_TAG_FRIENDS).build();
    public static final Expense KARAOKE = new ExpensesBuilder().withName("Karaoke: KTV")
            .withCost("10.00")
            .withDate(CommandTestUtil.VALID_DATE_2018)
            .withTags(CommandTestUtil.VALID_TAG_FRIENDS).build();
    ...
    public static final Expense KFC = new ExpensesBuilder().withName("KFC")
            .withDate("04/26/2019")
            .withCost("13.00")
            .withTags(CommandTestUtil.VALID_TAG_FOOD, "dinner").build();

    // Manually added
    public static final Expense BOWLING =
            new ExpensesBuilder().withName(CommandTestUtil.VALID_NAME_BOWLING)
            .withCost(CommandTestUtil.VALID_COST_BOWLING)
            .withDate(CommandTestUtil.VALID_DATE_2018)
            .withTags(CommandTestUtil.VALID_TAG_FRIENDS).build();
    public static final Expense IPHONE =
            new ExpensesBuilder().withName(CommandTestUtil.VALID_NAME_IPHONE)
                    .withCost(CommandTestUtil.VALID_COST_IPHONE)
                    .withDate(CommandTestUtil.VALID_DATE_2019).build();
