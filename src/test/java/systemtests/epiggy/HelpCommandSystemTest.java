 ...
 */
@Ignore
public class HelpCommandSystemTest extends EPiggySystemTestWithDefaultData {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(DeleteExpenseCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
